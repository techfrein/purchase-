...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-white p-0 lg:p-6">
      {/*
      ...
      */}
      <div className="app-shell flex min-h-screen flex-col lg:min-h-[calc(100vh-3rem)] lg:flex-row">
        <Sidebar
          user={{ name: user.name, role: user.role }}
          pendingApprovals={pendingApprovals}
        />
        <div className="flex min-w-0 flex-1 flex-col bg-subtle-gradient">
